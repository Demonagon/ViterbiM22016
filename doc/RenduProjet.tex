...
Nos tests s'articulent autour de deux paramètres : le paramètre de lissage $\alpha$ et le paramètre de taille de corpus $c$. Pour chacune de ces variations, nous donnerons une table correspondant aux performances d'étiquettage, et une table de performance relative en temps.
...
\hline\hline
$\alpha = 0.0$ & $60.7\%$ & $58.4\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ \\
\hline
$\alpha = 0.1$ & $94.4\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ \\
\hline
$\alpha = 0.2$ & $94.2\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ \\
\hline
$\alpha = 0.3$ & $94.3\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ \\
\hline
$\alpha = 0.4$ & $94.1\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ \\
\hline
$\alpha = 0.5$ & $94.0\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ \\
\hline
$\alpha = 0.6$ & $94.0\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ \\
\hline
$\alpha = 0.7$ & $93.9\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ \\
\hline
$\alpha = 0.8$ & $93.7\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ \\
\hline
$\alpha = 0.9$ & $93.6\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ \\
\hline
$\alpha = 1.0$ & $93.4\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ \\
\hline
\end{tabular}
...
Valeurs d'$\alpha$ & c = 1.0 & c = 0.9 & c = 0.8 & c = 0.7 & c = 0.6 & c = 0.5 & c = 0.4 \\
\hline\hline
$\alpha = 0.0$ & $2.88s$ & $2.87s$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ \\
\hline
$\alpha = 0.1$ & $3.00s$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ \\
\hline
$\alpha = 0.2$ & $3.00s$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ \\
\hline
$\alpha = 0.3$ & $3.00s$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ \\
\hline
$\alpha = 0.4$ & $3.00s$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ \\
\hline
$\alpha = 0.5$ & $3.00s$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ \\
\hline
$\alpha = 0.6$ & $3.01s$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ \\
\hline
$\alpha = 0.7$ & $3.01$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ \\
\hline
$\alpha = 0.8$ & $3.00$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ \\
\hline
$\alpha = 0.9$ & $3.03s$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ \\
\hline
$\alpha = 1.0$ & $2.99s$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ \\
\hline
\end{tabular}
...
\hline\hline
$I = 10$ & $94.3\%$ & $93.7\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ \\
\hline
$I =  9$ & $93.8\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ \\
\hline
$I =  8$ & $94.0\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ \\
\hline
$I =  7$ & $94.0\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ \\
\hline
$I =  6$ & $94.1\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ \\
\hline
$I =  5$ & $94.0\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ \\
\hline
$I =  4$ & $93.5\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ \\
\hline
$I =  3$ & $92.9\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ \\
\hline
$I =  2$ & $94.0\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ \\
\hline
$I =  1$ & $91.4\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ & $xxx\%$ \\
\hline
\end{tabular}
...
Valeurs de $I$ & c = 1.0 & c = 0.9 & c = 0.8 & c = 0.7 & c = 0.6 & c = 0.5 & c = 0.4 \\
\hline\hline
$I = 10$ & $146s$ & $131.1s$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ \\
\hline
$I =  9$ & $131s$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ \\
\hline
$I =  8$ & $117s$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ \\
\hline
$I =  7$ & $103s$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ \\
\hline
$I =  6$ & $88.8s$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ \\
\hline
$I =  5$ & $74.3s$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ \\
\hline
$I =  4$ & $60.0s$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ \\
\hline
$I =  3$ & $45.7s$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ \\
\hline
$I =  2$ & $31.3s$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ \\
\hline
$I =  1$ & $17.1s$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ & $xxxs$ \\
\hline
\end{tabular}
